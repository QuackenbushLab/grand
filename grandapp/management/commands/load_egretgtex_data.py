...
from grandapp.models import Tissuesampleegret
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        print("Loading egret tissue sample data!")
        for row in DictReader(open('./data/egret_gtex.csv')):
            tissuesample = Tissuesampleegret()
            ...
            tissuesample.cleanname   = row['cleanname']
            tissuesample.save()
